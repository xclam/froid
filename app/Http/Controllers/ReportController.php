...
class ReportController extends Controller
{
  ...
  /**
   * Create the repport step by step.
   *
   * @return view
   */
	public function step( Request $request, $step = null, Report $report = null )
	{
		...
		if( $step == 1 ){
			...
			$sites = Site::all();
			$next = "step-2";
			return view( 'report.create', compact( 'report', 'customers', 'machines', 'sites', 'step' , 'next') );
		}
  ...
  public function create()
  {
    ...
    public function edit(Report $report)
    {
		...
		$machines = Machine::all();
		$sites = Site::all();
        return view( 'report.edit', compact( 'report', 'customers', 'machines', 'sites' ) );
    }
