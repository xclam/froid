$(document).ready(function(){
	...
	$( 'form.show-form :input' ).each(function(){
 ...
 *
 */
$( '.main-mask' ).on( 'change', '.input-field[data-control_change]', function(){
 ...
 */
$( '.main-mask' ).on( 'change', '.input-field[data-status_change]', function(){
